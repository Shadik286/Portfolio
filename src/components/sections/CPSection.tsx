        ...
        <div className="card-stage grid gap-5">
          ...
          <div className="grid gap-5 md:grid-cols-[1.2fr_1fr]">
            <motion.div
              {...reveal()}
            >
              <Card amber className="h-full p-8">
                <div className="mb-6 flex items-center gap-3" {...fly({ x: -10, y: 8, z: 42 })}>
                  <SiCodeforces className="h-5 w-5 text-amber" />
                ...
                <p
                  className="text-5xl font-semibold tracking-tight text-amber md:text-6xl"
                ...
                <div
                  className="mt-6 flex flex-wrap items-baseline gap-x-10 gap-y-3"
                  {...fly({ x: 8, y: 9, z: 26, d: 0.1 })}
                >
                  <div>
                    <p className="font-mono text-3xl font-semibold text-fg">1576</p>
                    <p className="mt-1 text-[11px] uppercase tracking-[0.14em] text-fg-dim">
                      Max rating
                    </p>
                  </div>
                  <div>
                    <p className="font-mono text-3xl font-semibold text-fg">6 Kyu</p>
                    <p className="mt-1 text-[11px] uppercase tracking-[0.14em] text-fg-dim">
                      AtCoder
                    </p>
                  </div>
              ...
              {cp.international.map((item, i) => (
                ...
                >
                  <Card amber className="h-full p-6">
                    ...
                    <p className="text-[15px] font-medium text-fg" {...fly({ x: 6, y: 8, z: 26, d: 0.05 })}>
                      {item.event}
                    </p>
                    <p
          ...
          >
            <Card className="p-7">
              <div className="mb-6 flex items-baseline justify-between" {...fly({ x: -8, y: 7, z: 34 })}>
